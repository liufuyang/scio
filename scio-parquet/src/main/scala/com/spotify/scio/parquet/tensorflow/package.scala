...
package object tensorflow {
  ...
  implicit class ParquetExampleScioContext(private val self: ScioContext) extends AnyVal {
     ...
     */
    def parquetExampleFile(path: String,
                           projection: Seq[String] = null,
                           predicate: FilterPredicate = null): SCollection[Example] =
  ...
  implicit class ParquetExampleSCollection(private val self: SCollection[Example]) extends AnyVal {
    ...
    def saveAsParquetExampleFile(path: String,
                                 schema: Schema,
                                 numShards: Int = WriteParam.DefaultNumShards,
                                 suffix: String = WriteParam.DefaultSuffix,
                                 compression: CompressionCodecName = WriteParam.DefaultCompression): ClosedTap[Example] =
